...
read -d '' genesis << EOF
{
  ...
  "initial_key": "VEX6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV",
...
signature-provider = VEX6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV=KEY:5KQwrPbwdL6PhXujxW37FSSQZ1JiwsST4cqQzDeyXtP79zkvFD3
send-whole-blocks = true
readonly = 0
p2p-max-nodes-per-host = 10
enable-stale-production = true
producer-name = vexcore
EOF
